...
export class StringUtils {
   ...
   * @memberof StringUtils
   */
  static replaceAll(sourceText: string, searchValue: string | RegExp, replacement: string): string {
   ...
   * @memberof StringUtils
   */
  static replace(sourceText: string, searchValue: string | RegExp, replacement: string): string {
